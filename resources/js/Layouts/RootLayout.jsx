...
function Navigation() {
   return (
      <nav className="font-display mt-px text-5xl font-medium tracking-tight text-white">
         <NavigationRow>
            <NavigationItem href="/mission">
               Our Mission <span className="arrow text-spursTurq">→</span>
            </NavigationItem>
            <NavigationItem href="/events">
               Events Hub <span className="arrow text-spursTurq">→</span>
            </NavigationItem>
         </NavigationRow>
         <NavigationRow>
            <NavigationItem href="https://devsanantonio.printify.me/products">
               Shop <span className="arrow text-spursTurq">→</span>
            </NavigationItem>
            <NavigationItem href="/bounties">
               Bounties <span className="arrow text-spursTurq">→</span>
            </NavigationItem>
         </NavigationRow>
         <style>
            {`
